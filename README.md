...
- Die **Strichstärke** der Karteninhalte stellt ein Schieberegler von 30 bis 200 %
  ein: dünner, wenn zwei Trassen dieselbe Straße entlanglaufen, kräftiger für den
  nassen Ausdruck im Halbdunkel – sie gilt für Strecken, Flächenumrisse und
  Koordinatengitter
...
- Darüber hinaus stellt ein Schieberegler die **Strichstärke** frei ein, unabhängig
  vom Format – für das Blatt an der Wand oder für eine dicht belegte Lage
